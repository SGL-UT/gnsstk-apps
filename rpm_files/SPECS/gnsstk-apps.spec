...
- Refactor swig bindings for enums to use similar naming conventions between C++ and python (e.g. gnsstk::TrackingCode::CA in C++ and gpstk.TrackingCode.CA in python)
