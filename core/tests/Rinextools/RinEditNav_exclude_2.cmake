...
message(STATUS "running ${RINDIFF} ${SOURCEDIR}/RinEditNav_exclude_2.exp ${TARGETDIR}/RinEditNav_exclude_2.out")

execute_process(COMMAND ${RINDIFF} ${SOURCEDIR}/RinEditNav_exclude_2.exp ${TARGETDIR}/RinEditNav_exclude_2.out
    OUTPUT_QUIET
...
message(STATUS "running ${RINHEADDIFF} -x ${EXCL1} ${SOURCEDIR}/RinEditNav_exclude_2.exp ${TARGETDIR}/RinEditNav_exclude_2.out")
