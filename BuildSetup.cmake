...
elseif( ${CMAKE_SYSTEM_NAME} MATCHES "Linux" )
    ...
    set( CMAKE_CXX_FLAGS_RELWITHDEBINFO "${CMAKE_CXX_FLAGS} -O2" )
    set( CMAKE_CXX_FLAGS_MINSIZEREL "${CMAKE_CXX_FLAGS} -O3" )
    set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Werror=return-type -Werror=deprecated" )
    set( CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS} -O0 -g" )
    set( CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS} -O3" )
    set( CMAKE_C_FLAGS_RELWITHDEBINFO "${CMAKE_C_FLAGS} -O2" )
    set( CMAKE_C_FLAGS_MINSIZEREL "${CMAKE_C_FLAGS} -O3" )
    set( CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} -shared" )
...
if( USE_RPATH )
    ...
    set( CMAKE_INSTALL_RPATH "${CMAKE_INSTALL_PREFIX}:$ORIGIN/../${CMAKE_INSTALL_LIBDIR}" )
    ...
    list( FIND CMAKE_PLATFORM_IMPLICIT_LINK_DIRECTORIES "${CMAKE_INSTALL_PREFIX}:$ORIGIN/../${CMAKE_INSTALL_LIBDIR}" isSystemDir )
